...
INSTALLED_APPS = [
    'accounts.apps.AccountsConfig',  # Solo una vez, y primero
...
DATABASES = {
    'default': {
        ...
        'USER': 'postgres.aksxfsuydmxpzmonmecb',  # Usuario correcto
        'PASSWORD': 'Gabychan_777',  # Contraseña correcta
        'HOST': 'aws-0-us-west-1.pooler.supabase.com',  # Host correcto
